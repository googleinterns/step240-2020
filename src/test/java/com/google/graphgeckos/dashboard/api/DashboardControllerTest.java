...
public class DashboardControllerTest {
  ...
  public void whenGivenZeroRevisionsOffsetZeroReturnsEmptyJSONArray() throws Exception {
    ...
    ResultActions result = mvc.perform(
      MockMvcRequestBuilders.get("/builders/entries={entriesNumber}/offset={offset}",
   ...
   *
   * Given: number of entries to return >= 0; offset b, b >= 0.
   * Expected behaviour: JSON list of length = number
   * of entries to return, more about offset and number at
   * {@link com.google.graphgeckos.dashboard.storage.DataRepository::getLastRevision}.
   * Returned list contains JSON representations of the BuildBotInfo instances.
   * Information about this JSON representations could be found at
   * {@link com.google.graphgeckos.dashboard.datatypes.BuildInfo}.
   */
  @Test
   ...
   *
   * Given: illegal argument value/values.
